...
T_amb_C = 21; % Ambient temperature [deg C]
...
d_1_test_m = ; % Precision uncertainty test values [m] (Note: Later function requires this to be defined even if unused)
...
for i_seg = 2:length(d_1_m_seg)
    ...
    Reg_Data_str{i_seg} = [num2str(d_1_m_seg{1}(1)),'m Diameter Aperture Regression Data'];

...
L = 0.0013; % Fixed value of L in mm
...
c1 = 615.5558; % Example coefficient for δ

c2 = 468.0947; % Example coefficient for θ

c3 = -52.2157; % Example coefficient for l
...
fprintf('Optimal delta: %.10f mm\n', x_opt_fmincon(1));

fprintf('Optimal theta: %.10f radians (%.6f degrees)\n', x_opt_fmincon(2), rad2deg(x_opt_fmincon(2)));

fprintf('Optimal l: %.10 mm\n', x_opt_fmincon(3));

fprintf('Minimum objective function value: %.10f\n', fval_fmincon);
